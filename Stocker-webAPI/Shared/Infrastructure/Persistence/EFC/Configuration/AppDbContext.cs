...
public class AppDbContext(DbContextOptions options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Product>().Property(t => t.Id).IsRequired().ValueGeneratedOnAdd();
        builder.Entity<Product>().Property(t => t.Name).IsRequired().HasMaxLength(50);
        builder.Entity<Product>().Property(t => t.PhotoUrl).HasMaxLength(255);
        builder.Entity<Product>().Property(t => t.SalePrice).IsRequired();
        builder.Entity<Product>().Property(t => t.Quantity).IsRequired();
        builder.Entity<Product>().Property(t => t.ExpiryDate).HasConversion(
        ...
        builder.Entity<Product>().HasMany(t => t.Assets);
